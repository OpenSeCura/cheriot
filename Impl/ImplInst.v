...
From Cheriot Require Import SpecDefines SpecDevice Clint SpecRevoker Plic ImplRevoker ImplDevice ImplDefines ImplFetch ImplDeferred Impl Binary.
...
Definition DefaultFetchCapacity    : nat := 4%nat.
Definition DefaultDeferredCapacity : nat := 4%nat.

Definition implSysTreeInst : Tree DomainElem :=
  implSysTree "core" PcAddrInit DefaultFetchCapacity DefaultDeferredCapacity concreteRevConfig concreteRegions.
